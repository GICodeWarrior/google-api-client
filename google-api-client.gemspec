...
APIs.
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<signet>, [">= 0.1.4"])
      s.add_runtime_dependency(%q<addressable>, [">= 2.2.2"])
      s.add_runtime_dependency(%q<httpadapter>, [">= 0.2.0"])
      ...
      s.add_dependency(%q<signet>, [">= 0.1.4"])
      s.add_dependency(%q<addressable>, [">= 2.2.2"])
      s.add_dependency(%q<httpadapter>, [">= 0.2.0"])
